...
FILTER_FIELDS = {"m_dwIndex", "m_strCode", "m_strName", "m_fLevel", "m_fAttFcStd(Attack)", "m_fStdDefFc(Defense)", "m_fMaxHP", "m_nChildMonNum"} #only export specific values from each to txt.
